sleep 3
xdg-open "https://www.github.com/Godisser/simpleupdater"
#!/bin/bash
...
if command_exists flatpak; then
    read -p "${GREEN} Do you want to update Flatpak? [y/N]: " update_flatpak
...
if command_exists snap; then
    read -p "${GREEN} Do you want to refresh Snap packages? [y/N]: " update_snap
...
echo -e "${GREEN}===================================================${NC}"
echo -e "${RED} If you wanna make a fork of this, you can :D             "
echo -e "${YELLOW} nano [update/update2/etc].bash | This is update3.bash "
echo -e "${GREEN} ======================================================="
